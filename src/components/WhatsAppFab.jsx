...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 grid h-14 w-14 place-items-center rounded-full bg-[#25D366] text-2xl shadow-2xl shadow-[#25D366]/40 transition-transform duration-200 hover:scale-105 active:scale-95 sm:bottom-7 sm:right-7"
    >
