      ...
      <header className="relative -mt-20 overflow-hidden bg-void px-5 pb-16 pt-32 text-lavender sm:px-8 sm:pb-20 sm:pt-36 short:pb-10 short:pt-24">
        ...
        <Container className="relative">
          <SectionHead
            tone="dark"
            level="h1"
            kicker="Contact MKLabs · Bulawayo, Zimbabwe"
        ...
        <Container>
          <div className="grid items-start gap-8 lg:grid-cols-[1fr_1.15fr]">
            ...
            <div className="grid gap-3">
              ...
              >
                <div className="text-[11px] font-bold uppercase tracking-wider text-night/65 dark:text-lavender/60">
                  Phone · WhatsApp
                </div>
              ...
              {contact.emails.map((email, index) => (
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-night/65 dark:text-lavender/55">{email.note}</p>
                </Reveal>
              ))}
              ...
              >
                ...
                <p className="mt-1 text-sm text-night/65 dark:text-lavender/55">{site.hours}</p>
              </Reveal>
